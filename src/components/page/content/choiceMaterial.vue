        ...
        <el-table v-loading="tableLoading" class="table-expand" :data="tableList" stripe border :max-height="tableHeight" style="width: 100%;">
            ...
            <el-table-column label="操作" width="165">
                <template scope="scope">
                    ...
                    <el-button type="danger" size="small" @click="cancelChoice(scope.row)">取消精选</el-button>
                </template>
            </el-table-column>
        </el-table>
            ...
            fetchList() { //获取列表
                ...
                if (isNaN(_self.filters.kw)) { //输入不为数字，值传入kw
                    if (_self.filters.type == 0) { // 0为按剧本搜索
                        paras.append('materialName', _self.filters.kw);
                    } else {
                ...
                httpPost('contentChoiceMaterialList', paras, _self, function (res) {
