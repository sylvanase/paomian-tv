    ...
    export default {
        ...
        computed: {
            detail(){ //返回详情
                ...
                if (_self.squareData) {
                    _self.title = '编辑广场页banner';
                    _self.formData = {
                        id: _self.squareData.id,
                        link: _self.squareData.appLink,
                        time: [_self.squareData.startTime, _self.squareData.endTime],
                        start: _self.squareData.startTime,
                        end: _self.squareData.endTime
                    }
                }
            }
        },
